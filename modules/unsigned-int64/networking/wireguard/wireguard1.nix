...
in {
  ...
  networking.wg-quick.interfaces.wireguard1 = {
    ...
    postUp = ''
      ...
      ${pkgs.iptables}/bin/iptables -t nat -A POSTROUTING -o wireguard1 -p tcp --sport 25565 -j SNAT --to-source 172.168.10.1:25565
    ...
    postDown = ''
      ...
      ${pkgs.iptables}/bin/iptables -t nat -D POSTROUTING -o wireguard1 -p tcp --sport 25565 -j SNAT --to-source 172.168.10.1:25565
