...
in {
  ...
  networking.wg-quick.interfaces.wireguard1 = {
    ...
    postUp = ''
      ${pkgs.iptables}/bin/iptables -t nat -A PREROUTING -i eth0 -p tcp --dport 45565 -j DNAT --to-destination 172.168.10.2:25565
    ...
    '';
    postDown = ''
      ${pkgs.iptables}/bin/iptables -t nat -D PREROUTING -i eth0 -p tcp --dport 45565 -j DNAT --to-destination 172.168.10.2:25565
