  ...
  users = {
    ...
    users = {
      ashuramaru = {
        ...
        extraGroups = [ "ashuramaru" "wheel" "networkmanager" "video" "audio" "docker" "podman" "libvirtd" "kvm" "qemu" "gaymer" ];
      ...
      meanrin = {
        ...
        extraGroups = [ "meanrin" "wheel" "networkmanager" "video" "audio" "docker" "podman" "libvirtd" "kvm" "qemu" "gaymer" ];
