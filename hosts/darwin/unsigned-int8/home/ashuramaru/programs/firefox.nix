...
let
  floorp_profile-fix = pkgs.floorp-bin.overrideAttrs {
    nativeBuildInputs = [ pkgs.makeBinaryWrapper ];
    postInstall = ''
      wrapProgram $out/Applications/Floorp.app/Contents/MacOS/floorp --set MOZ_LEGACY_PROFILES 1
    '';
  };
  firefox_profile-fix = pkgs.firefox-bin.overrideAttrs {
    nativeBuildInputs = [ pkgs.makeBinaryWrapper ];
    postInstall = ''
