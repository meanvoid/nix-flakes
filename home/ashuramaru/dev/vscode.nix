...
in
{
  ...
  programs.vscode = {
    ...
    userSettings = {
      ...
      "nix" = {
        ...
        "serverSettings.nil" = {
          "formatting" = {
            "command" = [
              "${pkgs.nixfmt-rfc-style}/bin/nixfmt -w=120 -v $(${pkgs.findutils}/bin/find * -type d | ${pkgs.gnugrep}/bin/grep -v \".direnv\")"
            ];
          };
          "nix" = {
            "binary" = "nix";
    ...
    extensions = builtins.attrValues {
      ...
      vscode-latex = vscode-marketplace.mathematic.vscode-latex;
